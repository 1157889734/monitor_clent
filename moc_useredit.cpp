...
QT_MOC_LITERAL(1, 9, 12), // "sendCloseMsg"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11), // "recvOpenMsg"
QT_MOC_LITERAL(4, 35, 8), // "userName"
QT_MOC_LITERAL(5, 44, 15), // "closeWidgetSlot"
QT_MOC_LITERAL(6, 60, 11), // "confirmSlot"
QT_MOC_LITERAL(7, 72, 10) // "cancleSlot"

    },
    "userEdit\0sendCloseMsg\0\0recvOpenMsg\0"
    "userName\0closeWidgetSlot\0confirmSlot\0"
    "cancleSlot"
};
...
void userEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->recvOpenMsg((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->closeWidgetSlot(); break;
        case 3: _t->confirmSlot(); break;
        case 4: _t->cancleSlot(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (userEdit::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&userEdit::sendCloseMsg)) {
                *result = 0;
                return;
            }
        }
