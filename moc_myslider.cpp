...
QT_MOC_LITERAL(1, 9, 20), // "presliderPressSianal"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 8), // "iPosTime"
QT_MOC_LITERAL(4, 40, 19) // "presliderMoveSianal"

    },
    "mySlider\0presliderPressSianal\0\0iPosTime\0"
    "presliderMoveSianal"
};
...
void mySlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->presliderPressSianal((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->presliderMoveSianal((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mySlider::presliderPressSianal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (mySlider::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mySlider::presliderMoveSianal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void mySlider::presliderPressSianal(int _t1)
{
...
// SIGNAL 1
void mySlider::presliderMoveSianal(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
